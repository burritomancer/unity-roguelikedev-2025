...
public class MapManager : MonoBehaviour
{
    ...
    public Tilemap ObstacleMap => obstacleMap;
    public Tilemap FogMap => fogMap;
    
    public List<RectangularRoom> Rooms => rooms;
    ...
    public void CreateEntity(string entity, Vector2 position)
    {
        switch (entity)
        {
            case "Player":
                ...
                break;
            case "Orc":
                Instantiate(Resources.Load<GameObject>("Orc"),
                    new Vector3(position.x + 0.5f, position.y + 0.5f, 0), Quaternion.identity).name = "Orc";
                break;
            case "Troll":
                Instantiate(Resources.Load<GameObject>("Troll"),
                    new Vector3(position.x + 0.5f, position.y + 0.5f, 0), Quaternion.identity).name = "Troll";
                break;
            default:
