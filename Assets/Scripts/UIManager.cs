...
public class UIManager : MonoBehaviour
{
    ...
    public bool IsMessageHistoryOpen => isMessageHistoryOpen;
    ...
    private void Start() => AddMessage("Hello and welcome, adventurer, to yet another dungeon!", "#0da2ff");
    ...
    public void AddMessage(string newMessage, string colorHex)
    {
        ...
        {
            TextMeshProUGUI messageHistoryLastChild = messageHistoryContent.transform
                .GetChild(messageHistoryContent.transform.childCount - 1).GetComponent<TextMeshProUGUI>();
            TextMeshProUGUI lastFiveHistoryLastChild = lastFiveMessagesContent.transform
                .GetChild(lastFiveMessagesContent.transform.childCount - 1).GetComponent<TextMeshProUGUI>();
        ...
        for (int i = 0; i < lastFiveMessagesContent.transform.childCount; i++)
        {
            ...
            TextMeshProUGUI lastFiveHistoryChild = lastFiveMessagesContent.transform
                .GetChild(lastFiveMessagesContent.transform.childCount - 1 - i).GetComponent<TextMeshProUGUI>();
            TextMeshProUGUI messageHistoryChild = messageHistoryContent.transform
                .GetChild(messageHistoryContent.transform.childCount - 1 - i).GetComponent<TextMeshProUGUI>();
